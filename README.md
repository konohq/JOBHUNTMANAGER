...
- 公開デモURL: [https://jobhuntmanager.onrender.com]
- GitHub: [https://github.com/konohq/JOBHUNTMANAGER](https://github.com/konohq/JOBHUNTMANAGER)

※ READMEに掲載している画面はサンプルデータを使用しています。
...
![カンバン画面](docs/images/dashboard-kanban.png)

### カンバンからの簡易応募登録

![カンバンからの簡易応募登録](docs/images/kanban-quick-add.png)

### 応募詳細画面

![応募詳細画面](docs/images/application-detail.png)

### 面接・タスク・メモ管理

![面接・タスク・メモ管理](docs/images/application-management.png)
